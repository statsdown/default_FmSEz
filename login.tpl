						...
						<div class="my-auto">
							...
							<ul class="affs-nav nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
								...
								{if $Login.allow_login_phone==1}
									<li class="nav-item">
										<a class="nav-link fs-14 bg-transparent {if $Get.action=="phone" || $Get.action=="phone_code" || !$Get.action}active{/if}" data-toggle="tab" href="#phone" role="tab" aria-selected="false" id="tab-phone">{$Lang.mobile_login}
										</a>
									</li>
								{/if}
								...
								{if $Login.allow_login_email==0 && $Login.allow_id==1}
									<li class="nav-item">
										<a class="nav-link fs-14 bg-transparent {if ($Login.allow_login_phone==0 && $Login.allow_id == 1)}active{/if}" data-toggle="tab" href="#email" role="tab" aria-selected="false" id="tab-email">{$Lang.id_login}</a>
									</li>
								{/if}
								...
								{if $Login.allow_login_email}
									<li class="nav-item">
										<a class="nav-link fs-14 bg-transparent {if ($Login.allow_login_phone==0 && $Login.allow_login_email == 1  && $Login.allow_id == 0) || $Get.action=="email"}active{/if} " data-toggle="tab" href="#email" role="tab" aria-selected="true" id="tab-email">{$Lang.email_login}</a>
									</li>
								{/if}
